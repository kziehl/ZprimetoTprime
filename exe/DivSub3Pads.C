...
void DivSub3Pads()
{
	...
	gStyle->SetOptStat(0);
	// load file
	TFile *file = new TFile("/home/kevin/Desktop/file/analysis_mistagrate_all");
	TFile *g = new TFile("/home/kevin/Desktop/file/analysis_mistagrate_fancy.root");
	//create histograms
	TH1F* httm = dynamic_cast<TH1F*>(g->Get("QCD_TTM_Zprime_mistag_all_M"));
	...
	TH1F* hzprimebkg = dynamic_cast<TH1F*>(g->Get("Zprime_2500_1500_TTM_Zprime_mistag_all_M"));
