...
int main()
{
	...
	TFile *file = new TFile("/nfs/dust/cms/user/kziehl/plots/Zprime/pt_eta/rootfile/BKG_Sum_false_positiv.root","RECREATE");
  ...
  for(Long64_t i=0; i<nentries; i++)
  {
  	...
  	//save to disk
  	cs->SaveAs("/nfs/dust/cms/user/kziehl/plots/Zprime/pt_eta/pdf/BKG_Sum_false_positiv.pdf");
  	file->cd();
  	divide->Write("BKG_Sum_false_positiv");
  	file->Close();
