...
int main()
{
	...
	TFile *file = new TFile("/nfs/dust/cms/user/kziehl/plots/Zprime/pt_eta/rootfile/BKG_QCD_false_negativ.root","RECREATE");
	...
	Double_t height_pt=GetMaxVal(chain,"misstagged_top_pt","N_misstagged_top");
  ...
  for(Long64_t i=0; i<nentries; i++)
  {
  	...
  	//save to disk
  	cs->SaveAs("/nfs/dust/cms/user/kziehl/plots/Zprime/pt_eta/pdf/BKG_QCD_false_negativ.pdf");
  	file->cd();
