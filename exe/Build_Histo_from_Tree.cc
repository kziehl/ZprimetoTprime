...
int main()
{
	...
	TFile *file = new TFile("/nfs/dust/cms/user/kziehl/plots/bkg_estimation/rootfile/analysis_TTbar.root","RECREATE");
  ...
  hZmassTopfirst->Write("TTbar_Signal_Topfirst_Zprime_M");
  ...
  hTmassTopfirst->Write("TTbar_Signal_Topfirst_Tprime_M");
  file->Close();
