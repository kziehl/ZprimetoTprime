...
int main()
{
	...
	TFile *file = new TFile("/nfs/dust/cms/user/kziehl/plots/bkg_estimation/rootfile/analysis_QCD_top.root","RECREATE");
  ...
  */
  ...
  file->cd();
  /*
  hZmass->Write("Zprime_1500_1200_TTM_Zprime_M");
  hZmassTopfirst->Write("Zprime_1500_1200_Signal_Topfirst_Zprime_M");
  hZmassnotop->Write("Zprime_1500_1200_TTM_no_top_Zprime_M");
  hTmass->Write("Zprime_1500_1200_TTM_Tprime_M");
  hTmassnotop->Write("Zprime_1500_1200_TTM_no_top_Tprime_M");
  hmisstag->Write("Zprime_1500_1200_misstag");
