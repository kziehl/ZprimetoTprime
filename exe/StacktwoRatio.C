...
void StacktwoRatio()
{
	...
	Ratio->GetLowerRefGraph()->SetMarkerSize(0.9);
	Ratio->GetLowerRefGraph()->SetMinimum(0.5);
	Ratio->GetLowerRefGraph()->SetMaximum(2.0);
	Ratio->GetLowerRefXaxis()->SetRangeUser(500,4500);
	...
	hsub->GetXaxis()->SetRangeUser(500,4500);
	hsub->Draw("pe");
	TLine *l = new TLine(500,0,4500,0);
	l->SetLineColor(1);
	l->SetLineStyle(2);
	l->Draw("same");
